    ...
    <PageContainer>
      <div>
        ...
        <div className="m-auto mt-20 max-w-[95rem] px-4">
          <div className="font-title decoration-primary-700 mb- w-full text-center text-2xl font-bold uppercase underline decoration-4 underline-offset-8 md:text-4xl">
